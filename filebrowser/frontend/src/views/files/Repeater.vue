    ...
    <template v-else>
      ...
      >
        <video
          ...
          v-if="isMediaType == 2 && !browserHiJack && !notSuportSpeechSynthesis"
          id="myVideo"
          :src="raw"
          :autoplay="autoPlay"
          :controls="!isSingle"
        ...
        <span
          v-if="srtSubtitles && isReadyToPlay && !notSuportSpeechSynthesis"
          style="
            flex-grow: 1;
            color: yellow;
      ...
      <audio
        style="
          ...
          margin: auto;
        "
        v-if="isMediaType == 1 && !browserHiJack && !notSuportSpeechSynthesis"
        id="myAudio"
        :src="raw"
        :controls="!isSingle"
...
export default {
  ...
  data: function () {
    return {
      ...
      currentMedia: null,
      notSuportSpeechSynthesis: false,
      resized: false,
      isFirstClick: true,
      hasSpeechSynthesis:
  ...
  watch: {
    ...
    raw: function () {
      if (this.isFavOnPlay && this.isPlayFullFavList) {
        ...
        this.playCount = 0;
        this.currentMedia.addEventListener(
          "canplaythrough",
          this.switchReadyToPlay
        );
      }
    },
  },
